...
namespace WiseQueue.Domain.MsSqlEntityFramework
{
    ...
    /// </summary>
    public static class WiseQueueEntityFrameworkConfiguration
    {
        /// <summary>
        ...
        public static IWiseQueueConfiguration UseEntitySqlServer(this IWiseQueueConfiguration configuration, string connectionString)
        {
            ...
            DependencyInjectionNinjectModule ninjectModule = new DependencyInjectionNinjectModule(connectionString);
