...
namespace WiseQueue.Domain.MsSql.MsSqlDataContext
{
    ...
    class ServerDataContext: BaseLoggerObject, IServerDataContext
    {
        ...
        public ServerDataContext(MsSqlSettings sqlSettings, ISqlConnectionFactory connectionFactory, ICommonLoggerFactory loggerFactory) : base(loggerFactory)
        {
            if (sqlSettings == null) 
        ...
        public Int64 InsertServer(ServerModel model)
        {
            ...
            string sqlCommand = string.Format(insertStatement, sqlSettings.WiseQueueDefaultSchema, serverTableName, model.Name, model.Description, model.HeartbeatLifetime);
        ...
        public int DeleteExpiredServers()
        {
            ...
            string sqlCommand = string.Format(deleteExpiredServersStatement, sqlSettings.WiseQueueDefaultSchema, taskTableName, serverTableName, (short)TaskStates.New, (short)TaskStates.Running);
